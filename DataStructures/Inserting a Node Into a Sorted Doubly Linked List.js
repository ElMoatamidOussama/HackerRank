...
function sortedInsert(head, data) {
    ...
    if(!head) return {data:data,next:null,prev:null};

    if(head.data>data){
         let newHead={data:data,next:head,prev:null};
         head.prev=newHead;
         return newHead;
    }
    ...
    if(currentNode.data>=data){
            let nodeToInsert={data:data,next:currentNode,prev:currentNode.prev}
            currentNode.prev.next=nodeToInsert;
            currentNode.prev=nodeToInsert;
    }else{
            let nodeToInsert={data:data,next:null,prev:currentNode}
